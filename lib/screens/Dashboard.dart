...
List<Widget> list = [
  ...
  DashboardCard(courseName: "MAT", courseID: "2001",time: "11:00 AM - 11:50 AM",theory: true,
      extraClass: false),
  DashboardCard(courseName: "PHY", courseID: "1701",time: "12:00 PM - 12:50 AM",theory: false,
      extraClass: true),
  DashboardCard(courseName: "CSE", courseID: "1003",time: "10:00 AM - 10:50 AM",theory: true,
      extraClass: false),
];
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index){
              return Container(
                margin: EdgeInsets.only(left:query.width*0.025, right: query.width*0.025),
                child: GestureDetector(
                  ...
                  onPanDown:(var x){
                    ...
                    if ( widget.selectedItem.contains(index) )
                      widget.selectedItem.removeWhere((element) => element==index);
                    else
                      widget.selectedItem.add(index);
                    ...
                    child: Row(
                        children: [
                         AnimatedContainer(
                            ...
                            child: !widget.heading.contains(index) && widget.startSelecting ? Checkbox(
